...
namespace APTI{
  ...
  std::string prepareGrResult(const CAGI::GradingResult & rGr){
    ...
    for(long i=0;i<numR;++i){
      niceRes+="<div class=\"messageBox\"><div class=\"card-body\">\n";
      bgc="bg-danger";
      if(rGr.testCasesRes[i].result=="success"){
        bgc="bg-success";
      }
      niceRes+="<div class=\"row\"><div class=\"col-sm-9 "+bgc +" text-light\"><B>Test case "+std::to_string(i+1);
      niceRes+="</B></div>  ";
      niceRes+="<div class=\"col-sm-3 "+bgc +" text-light\"> <B>"+ rGr.testCasesRes[i].result;
      niceRes+="</B></div>\n</div>  ";
      niceRes+="<h5>Input</h5>";
