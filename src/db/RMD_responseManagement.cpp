...
#ifndef _INCL_RESPONSEMANAGEMENT_CPP
#define _INCL_RESPONSEMANAGEMENT_CPP

namespace RMD{
  class Response:public ATMD::Text{
  private:


    std::string ow2_dbs_key0="id";
    std::string ow2_dbs_key1="name";
    std::string ow2_dbsMFInd="response";
    std::string ow2_cntrName="responseCntr";


    long ow2_primeIndex0=11;
    long ow2_primeIndex1=15;
  ...
  Response::Response(const std::string & _tn, const std::string &  _intTId){
    setVariables(_tn,_intTId);
  }
  void Response::setVariables(const std::string & _tn, const std::string &  _intTId){
